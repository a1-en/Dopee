        ...
        <div className="mb-8">
          ...
          <div className="text-center">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-100 to-teal-100 rounded-full px-4 py-2 mb-4">
              ...
              <span className="text-emerald-700 font-medium">Shoes Collection</span>
            </div>
            <h1 className="text-5xl font-bold text-gray-900 mb-4">Premium Footwear</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Step into style with our collection of premium shoes. From athletic performance 
              to casual comfort, find the perfect pair for every occasion.
            </p>
          </div>
        </div>
